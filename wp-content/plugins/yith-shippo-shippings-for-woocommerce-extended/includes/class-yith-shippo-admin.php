...
class YITH_Shippo_Admin {
	...
	public function plugin_row_meta( $new_row_meta_args, $plugin_meta, $plugin_file ) {
		if ( defined( 'YITH_SHIPPO_INIT' ) && YITH_SHIPPO_INIT === $plugin_file ) {
			...
			$new_row_meta_args['support']       = array( 'url' => admin_url( 'admin.php?page=bluehost#/help' ) );
			$new_row_meta_args['documentation'] = array( 'url' => 'https://www.bluehost.com/help/article/' . YITH_SHIPPO_SLUG );
		}
