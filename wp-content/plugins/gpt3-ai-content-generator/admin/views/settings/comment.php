...
<div id="tabs-10">
    <div class="wpcgai_form_row" style="display: flex;align-items: flex-start;">
        ...
        <div style="width: 65%;">
            ...
            <p><?php echo sprintf(esc_html__('Read the %s for more information.','gpt3-ai-content-generator'),'<a href="https://gptaipower.com/comment-replier-gpt-powered-engagement-assistant-for-wordpress/" target="_blank">'.esc_html__('documentation','gpt3-ai-content-generator').'</a>')?></p>
        </div>
    </div>
</div>
