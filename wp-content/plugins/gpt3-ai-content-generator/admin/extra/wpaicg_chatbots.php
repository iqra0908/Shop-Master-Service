            ...
            <form action="" method="post" class="wpaicg-bot-form">
                ...
                <div class="wpaicg-bot-audio wpaicg-bot-wizard" style="display: none">
                    ...
                    <div class="wpaicg-mb-10">
                        ...
                        <input<?php echo empty($wpaicg_elevenlabs_api) ? ' disabled':''?> class="wpaicg_chatbot_chat_to_speech" value="1" type="checkbox" name="bot[chat_to_speech]">
                    </div>
                    <div class="wpaicg-mb-10">
                        <label class="wpaicg-form-label"><?php echo esc_html__('Select a Voice','gpt3-ai-content-generator')?>:</label>
                        <select<?php echo empty($wpaicg_elevenlabs_api) ? ' disabled':''?> name="bot[elevenlabs_voice]" class="wpaicg_chatbot_elevenlabs_voice">
                            <?php
