...
class EnDistanceBaseShippingConfig
{
    ...
    static public function do_config()
    {
        ...
        define('EN_DISTANCE_BASE_SHIPPING_ROOT_URL', 'https://ws076.eniture.com');
        ...
        define('EN_DISTANCE_BASE_SHIPPING_SET_CONNECTION_SETTINGS', wp_json_encode(EnDistanceBaseShippingConnectionSettings::en_set_connection_settings_detail()));
