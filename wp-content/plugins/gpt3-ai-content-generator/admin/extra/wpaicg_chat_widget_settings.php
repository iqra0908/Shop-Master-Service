        ...
        <form action="" method="post" id="form-chatbox-setting">
            ...
            <div class="wpaicg-collapse">
                ...
                <div class="wpaicg-collapse-content">
                    ...
                    <div class="mb-5">
                        <label class="wpaicg-form-label"><?php echo esc_html__('Chat Window Rounded','gpt3-ai-content-generator')?>:</label>
                    ...
                    <div class="mb-5">
                        <label class="wpaicg-form-label"><?php echo esc_html__('Text Field Rounded','gpt3-ai-content-generator')?>:</label>
            ...
            <div class="wpaicg-collapse">
                ...
                <div class="wpaicg-collapse-content">
                    ...
                    <div class="mb-5">
                        ...
                        <input<?php echo empty($wpaicg_elevenlabs_api) ? ' disabled':''?><?php echo !empty($wpaicg_elevenlabs_api) && $wpaicg_chat_to_speech ? ' checked':''?> value="1" type="checkbox" name="wpaicg_chat_widget[chat_to_speech]">
                    </div>
                    <div class="mb-5">
                        <label class="wpaicg-form-label"><?php echo esc_html__('Select a Voice','gpt3-ai-content-generator')?>:</label>
                        <select<?php echo empty($wpaicg_elevenlabs_api) ? ' disabled':''?> name="wpaicg_chat_widget[elevenlabs_voice]">
                            <?php
